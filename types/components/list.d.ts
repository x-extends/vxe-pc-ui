...
export type VxeListInstance<D = any> = DefineVxeComponentInstance<VxeListProps<D>, VxeListConstructor<D>>

export interface VxeListConstructor<D = any> extends VxeComponentBaseOptions, VxeListMethods<D> {
  props: VxeListProps
