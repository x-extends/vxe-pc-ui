...
export type VxeTableTransferComponent = DefineVxeComponentOptions<VxeTableTransferProps, VxeTableTransferEventProps>

export type VxeTableTransferInstance = DefineVxeComponentInstance<VxeTableTransferProps, VxeTableTransferConstructor>

export interface VxeTableTransferConstructor extends VxeComponentBaseOptions, VxeTableTransferMethods {
  props: VxeTableTransferProps
  context: SetupContext<VxeTableTransferEmits>
  reactData: TableTransferReactData
  internalData: TableTransferInternalData
  getRefMaps(): TableTransferPrivateRef
  getComputeMaps(): TableTransferPrivateComputed
