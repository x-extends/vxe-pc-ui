import { DefineVxeComponentApp, DefineVxeComponentOptions, DefineVxeComponentInstance, VxeComponentEventParams, ValueOf, VxeComponentSizeType, VxeComponentSlotType } from '@vxe-ui/core'
...
export type VxeContextMenuComponent = DefineVxeComponentOptions<VxeContextMenuProps>

export type VxeContextMenuInstance = DefineVxeComponentInstance<{
  internalData: ContextMenuInternalData
  reactData: ContextMenuReactData
}, VxeContextMenuProps, VxeContextMenuPrivateComputed, VxeContextMenuMethods>

export type VxeContextMenuConstructor = VxeContextMenuInstance
...
export type VxeContextMenuProps = {
  value?: VxeContextMenuPropTypes.ModelValue
...
export type VxeContextMenuEventProps = {
  onInput?: VxeContextMenuEvents.UpdateModelValue
  onModelValue?: VxeContextMenuEvents.UpdateModelValue
...
export interface VxeContextMenuListeners {
  input?: VxeContextMenuEvents.UpdateModelValue
  modelValue?: VxeContextMenuEvents.UpdateModelValue
