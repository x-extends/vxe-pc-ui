<template>
  <div>
    ...
    <p>
      <vxe-upload v-model="fileList" multiple :limit-size="30" showDownloadButton show-error-status :more-config="{maxCount: 2, layout: 'horizontal'}" show-progress>
        <template #corner>
    ...
    <p>
      <vxe-upload v-model="imgList" mode="image" multiple show-error-status showDownloadButton :more-config="{maxCount: 2}" show-progress>
        <template #corner>
          <vxe-button mode="text" icon="vxe-icon-edit"></vxe-button>
          <vxe-button mode="text" icon="vxe-icon-edit"></vxe-button>
        </template>
