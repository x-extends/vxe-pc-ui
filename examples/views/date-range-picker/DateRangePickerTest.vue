<template>
  <div>
    <p>
      <vxe-date-range-picker v-model="demo1.value100" placeholder="默认尺寸" :auto-close="false"></vxe-date-range-picker>
      <vxe-date-range-picker v-model="demo1.value101" placeholder="中等尺寸" size="medium"></vxe-date-range-picker>
      <vxe-date-range-picker v-model:start-value="demo1.start100" v-model:end-value="demo1.end100" placeholder="小型尺寸" size="small"></vxe-date-range-picker>
      <vxe-date-range-picker v-model="demo1.value103" v-model:start-value="demo1.start101" v-model:end-value="demo1.end101" placeholder="超小尺寸" size="mini"></vxe-date-range-picker>
    </p>
